...
//        $daemonRpc->stopSaveGraph();
    ...
    public function testGetInfo(): void
    {
        ...
        self::assertEquals(600000, $result['block_size_limit']);
        self::assertEquals(false, $result['update_available']);
    }
    ...
    public function testGetBlock(): void
    {
        ...
        self::assertEquals('7c705f18639eb0cd2709ed720916ed3cdd16700e276ac580f532497ca75bdd5a', $result['miner_tx_hash']);
        self::assertEquals('c84a83ce60446bf5093ac2aa0fc5760bf686f2e8787b325bdae4fee086c8de8f', $result['tx_hashes'][2]);
    }
    ...
    public function testGetBlockHeaderByHash(): void
    {
        ...
        self::assertEquals(280545472328279964, $result['block_header']['cumulative_difficulty']);
        self::assertEquals('7c705f18639eb0cd2709ed720916ed3cdd16700e276ac580f532497ca75bdd5a', $result['block_header']['miner_tx_hash']);
        self::assertEquals(false, $result['block_header']['orphan_status']);
    }
    ...
    public function testGetMiningStatus(): void
    {
        ...
        self::assertEquals(false, $result['is_background_mining_enabled']);
        self::assertEquals(false, $result['bg_ignore_battery']);
    }
